                ...
                <div class="side-two">
                    <form id="new_recipe">
                        ...
                        <div class="field">
                            ...
                            <QuillEditor
                                v-model:content="ingredientes"
                                theme="snow"
                                :toolbar="[{ 'list': 'bullet' }]"
                                placeholder="Digite sua receita aqui"></QuillEditor>
                        </div>
                        <div class="field">
                            <label for="preparo" class="preparo">Modo de preparo</label>
                            <QuillEditor
                                v-model:content="modoPreparo"
                                theme="snow" :toolbar="[{ 'list': 'bullet' }]"
                                placeholder="Digite o modo de preparo aqui"></QuillEditor>
                        </div>
